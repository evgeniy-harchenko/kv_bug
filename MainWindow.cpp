...
void addToolButton(QToolBar *toolbar, const QString &text, const QIcon &icon) {
...
void MainWindow::createToolbar()
{
    ...
    addToolButton(toolbar, "Open", QIcon::fromTheme("document-open"));
    addToolButton(toolbar, "Save", QIcon::fromTheme("document-save"));
    addToolButton(toolbar, "Close", QIcon::fromTheme("window-close"));
}
